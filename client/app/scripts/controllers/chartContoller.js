...
var app = angular.module('sbAdminApp');
  app.controller('CPUCtrl', ['$scope', '$timeout', '$http', '$filter',function ($scope, $timeout, $http, $filter) {
    ...
    var urlbase = "http://10.189.99.141:8080/ec2/query/"+"start="+$scope.startdata+"&end="+$scope.enddata+"&type=CPUUtilization&interval="+$scope.timeinterval;
