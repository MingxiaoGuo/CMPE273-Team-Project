...
var app = angular.module('sbAdminApp');
  app.controller('REQUESTCtrl', ['$scope', '$timeout', '$http', '$filter',function ($scope, $timeout, $http, $filter) {
    ...
    var urlbase = "http://10.189.97.101:8080/ec2/query/"+"start="+$scope.startdata+"&end="+$scope.enddata+"&type=HTTP&interval="+$scope.timeinterval;
    ...
    .then(function(response) {
        ...
        $scope.line1.data[0] = response.data.count;
    ...
    .then(function(response) {
        $scope.datas = response.data;
        $scope.line2.data[0] = response.data.count;
    ...
    .then(function(response) {
        $scope.datas = response.data;
        $scope.line3.data[0] = response.data.count;
    ...
    //var url = urlbase+"&instanceid=4";
    var url = urlbase+"&instanceid=i-2c86ce9e";
    $http.get(url)
    .then(function(response) {
        $scope.datas = response.data;
        $scope.line4.data[0] = response.data.count;
