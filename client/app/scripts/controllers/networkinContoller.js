...
var app = angular.module('sbAdminApp');
  app.controller('NetworkInCtrl', ['$scope', '$timeout', '$http', '$filter',function ($scope, $timeout, $http, $filter) {
    ...
    var urlbase = "http://10.189.97.101:8080/ec2/query/"+"start="+$scope.startdata+"&end="+$scope.enddata+"&type=NetworkIn&interval="+$scope.timeinterval;
